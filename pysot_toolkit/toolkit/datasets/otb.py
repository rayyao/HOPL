...
class OTBVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
            gt_rect, attr=None,load_img=False):
    ...
    def load_tracker(self, path, tracker_names=None, store=True):
        ...
        for name in tracker_names:
            ...
            if os.path.exists(traj_file)or txt_name=='fruit' :
...
class OTBDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        #with open(os.path.join(dataset_root +'HSI-VIStest.json'), 'r') as f:
        #with open(os.path.join(dataset_root + 'HSI-RedNIRtest.json'), 'r') as f:
        #with open(os.path.join(dataset_root + 'HSI-NIRtest.json'), 'r') as f:
        with open(os.path.join(dataset_root + 'ALLtest.json'), 'r') as f:
