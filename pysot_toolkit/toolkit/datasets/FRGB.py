...
class FRGBVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(FRGBVideo, self).__init__(name, root, video_dir,
...
class FRGBDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(FRGBDataset, self).__init__(name, dataset_root)
        with open(os.path.join(dataset_root +'FRGB.json'), 'r') as f:
        ...
        for video in pbar:
            ...
            self.videos[video] = FRGBVideo(video,
                                          dataset_root,
                                          meta_data[video]['video_dir'],
                                          meta_data[video]['init_rect_i'],
                                          meta_data[video]['img_names'],
                                          meta_data[video]['gt_rect_i'],
                                          load_img)
