...
from pysot_toolkit.toolkit.visualization.draw_utils import COLOR, MARKER_STYLE
...
if __name__ == '__main__':
    result = pickle.load(open("/home/zl/Band selection/pysot_toolkit/results/OTB100", 'rb'))
    draw_eao(result)
