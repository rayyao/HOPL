...
parser.add_argument('--tracker_path', '-p', type=str, default='/home/zl/ThreePrompt/HOPL/results/HOPL_test/',help='tracker result path')
#parser.add_argument('--tracker_path', '-p', type=str, default='/home/zl/TransT-main/pytracking/networks/TransT_ep0005.pth',help='tracker result path')
parser.add_argument('--dataset', '-d', type=str, default='OTB100',
                    help='dataset name')
parser.add_argument('--num', '-n', default=1, type=int,
                    help='number of thread to eval')
parser.add_argument('--tracker_prefix', '-t', default='transt',
...
def main():
    ...
    root = os.path.join('/home/zl/HSI2023/test/HSI-RedNIR/' )
