...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=300, debug=0, script_name='prompt'):
    ...
    save_path = f'/home/zl/ThreePrompt/viptnew/results/{dataset_name}/' + save_name + '/' + seq_txt + '.txt'
    save_folder = f'/home/zl/ThreePrompt/viptnew/results/{dataset_name}/' + save_name
    ...
    for frame_idx, HSI_path in enumerate(HSI_img_list):
        ...
        if frame_idx == 0:
            # initialization
            last_path=f'/HSI2023/test/HSI-RedNIR/' + seq_txt + '/' + '{:04}.png'.format(
                1)
...
if __name__ == '__main__':
    ...
    seq_list = None
    seq_home = '/HSI2023/test/HSI-RedNIR/'
