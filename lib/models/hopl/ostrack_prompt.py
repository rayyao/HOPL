...
from HOPL.lib.models.layers.head import build_box_head
from HOPL.lib.models.hopl.vit_prompt import vit_base_patch16_224_prompt
from HOPL.lib.models.hopl.vit_ce_prompt import vit_base_patch16_224_ce_prompt
from HOPL.lib.utils.box_ops import box_xyxy_to_cxcywh
...
def build_viptrack(cfg, training=True):
    ...
    # use pretrained OSTrack as initialization

    #pretrained_path='/home/zl/newvipt/HOPL/output/checkpoints/train/hopl/shaw_rgbt/ViPTrack_ep0005.pth.tar'
    if cfg.MODEL.PRETRAIN_FILE and ('OSTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
        pretrained = os.path.join(pretrained_path, cfg.MODEL.PRETRAIN_FILE)
        #pretrained='/home/zl/ThreePrompt/HOPL/pretrained/OSTrack_ep0300.pth.tar'
    else:
        pretrained = ''
