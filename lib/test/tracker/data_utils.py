...
class PreprocessorMM(object):
    def __init__(self):
        self.mean = torch.tensor([0.485, 0.456, 0.406, 0.485, 0.456, 0.406,0.485, 0.456, 0.406, 0.485, 0.456, 0.406]).view((1, 12, 1, 1)).cuda()
        self.std = torch.tensor([0.229, 0.224, 0.225, 0.229, 0.224, 0.225,0.229, 0.224, 0.225, 0.229, 0.224, 0.225]).view((1, 12, 1, 1)).cuda()
